                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                                <label class="control-label">Cash In</label>
                                <input type="reset" class="form-control" value="${data.cashin}"/>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                                <label class="control-label">Cash Out</label>
                                <input type="reset" class="form-control" value="${data.cashout}"/>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="reset" class="form-control" value="${data.pidin}"/>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                                <label class="control-label">Paid Out</label>
                                <input type="reset" class="form-control" value="${data.paidout}"/>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="reset" class="form-control" value="${data.salesamount}"/>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                                <label class="control-label">Discount Amount</label>
                                <input type="reset" class="form-control" value="${data.discount}"/>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="reset" class="form-control" value="${data.returned}"/>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                                <label class="control-label">Net Sales Amount</label>
                                <input type="reset" class="form-control"
                                       value="${data.salesamount-data.discount-data.returned}"/>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control number keyboard" id="float"/>
                            </div>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control number keyboard" id="inhand"/>
                            </div>
                        </div>
                        <button class="btn btn-info btn-icon btn-rounded " onclick="counterClose()"><i
                                class="icon icon-logout"></i> Shift Close
                        </button>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    function counterClose() {
        window.location = "<%=request.getContextPath()%>/counterCloseByUser/" + ($("#float").val().length > 0 ? $("#float").val() : 0) + "/" + ($("#inhand").val().length > 0 ? $("#inhand").val() : 0);
    }
