        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-header card-default">
                    Salary Advance
                    <p class="text-muted">All Salary Advance List</p>
                    <div class="float-right mt-10">
                        <button type="button" class="btn btn-primary margin-r-5 btn-rounded box-shadow btn-icon"
                                data-toggle="modal" data-target=".myModel"><i class="fa fa-plus"></i>Create New Salary
                            Advance
                        </button>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <button type="button" class="btn btn-sm btn-danger delete"
                                            data-set='{"title":"${item.description}", "id":${item.idsalaryadvance}}'>
        ...
        <form id="newproducttypeid" name="newproducttypeid" method="PUT" action="">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h5 class="modal-title" id="myModalLabel">Create New Salary Advance</h5>
                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <div class="input-group m-b">
                                    ...
                                    <select type="number" id="newEmployee"
                                            class="checkbox-primary form-control">
                                        <c:forEach items="${EMPdataList}" var="item">
                                            <option value="${item.idemployee}">${item.fullname}</option>
                                        </c:forEach>
                                    </select>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="newdate" id="newdate" value="${currentDate}"/>
                                </div>
                            </div>
                        </div>
    ...
    $(function () {
            ...
            swal({
                ...
                preConfirm: function () {
                    return new Promise(function (resolve) {
                        $.ajax({
                            url: 'salaryadvance/delete/' + data.id, /* php post url */
                            type: 'POST',
                            data: {
                                id: data.id
                            },
        ...
        $("#newBtn").click(function () {
            var data = {
                ...
                "workshiftIdworkshift": ${sessionScope.WorkShiftID},
                "locationIdlocation": ${sessionScope.LocationID},
                "usersIdusers": ${sessionScope.userid},
                "amount": $("#newAmount").val(),
                "sallrydate": new Date($("#newdate").val()),
                "employeeIdemployee": $("#newEmployee").val()
            };
            $.ajax({
                url: 'salaryadvance/add', /* php post url */
                type: 'POST',
