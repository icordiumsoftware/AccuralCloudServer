        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-header card-default">
                    Location
                    <p class="text-muted">All Location List</p>
                    <div class="float-right mt-10">
                        <button type="button" class="btn btn-primary margin-r-5 btn-rounded box-shadow btn-icon"
                                data-toggle="modal" data-target=".myModel"><i class="fa fa-plus"></i>Add New Location
                        </button>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <button type="button" class="btn btn-sm btn-success edit"
                                            data-set='{"title": "${item.locationname}", "locationname":"${item.locationname}", "description":"${item.description}", "adress":"${item.adress}", "status":${item.status}, "id":${item.idlocation}}'>
                                        <i class="fa fa-edit"></i></button>
                                    <button type="button" class="btn btn-sm btn-danger delete"
                                            data-set='{"title":"${item.locationname}", "status":${item.status}, "id":${item.idlocation}}'>
...
<div id="newModelId" class="modal fadeIn myModel" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <form id="newLocationid" name="newLocationid" method="post" action="">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"
                                                                                                      class="fa fa-times"></span>
                    </button>
                    <h5 class="modal-title" id="myModalLabel">Create New Location</h5>
                </div>
                <div class="modal-body">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <div class="input-group m-b">
                                    ...
                                    <input type="text" id="newLocationAddress" class="checkbox-primary form-control"/>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <label for="newLocationDescription">
                                <h5>
                                    <small>Location Desscription</small>
                                </h5>
                            </label>
                            <div class="form-group">
                                <div class="input-group m-b">
                                    <span class="input-group-addon"><i class="glyphicon icon-tag"></i></span>
                                    <input type="text" id="newLocationDescription" name="producttypedescription"
                                           class="form-control"/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <div class="input-group m-b col-md-1">
                                    <input type="checkbox" id="newLocationStatus"
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <div class="input-group m-b">
                                <input type="text" id="editLocationName" name="newLocationName"
                                       class="form-control"/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <div class="input-group m-b">
                                <input type="text" id="editLocationAddress" class="checkbox-primary form-control"/>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <label for="editLocationDescription">
                            <h5>
                        ...
                        <div class="form-group">
                            <div class="input-group m-b">
                                <input type="text" id="editLocationDescription" class="form-control"/>
...
<script type="text/javascript">
    $(function () {
            ...
            swal({
                ...
                preConfirm: function () {
                    return new Promise(function (resolve) {
                        $.ajax({
                            url: '/locations/delete/' + data.id, /* php post url */
                            type: 'POST',
                            data: {
                                id: data.id
                            },
        ...
        $(".edit").click(function () {
            ...
            $('#editLocationName').val(data.locationname.toString());
            $('#editLocationAddress').val(data.adress.toString());
            $('#editLocationDescription').val(data.description.toString());
        ...
        $("#newBtn").click(function () {
            var data = {
                ...
                "description": $("#newLocationDescription").val(),
                "adress": $("#newLocationName").val(),
                "status": $("#newLocationStatus").is(":checked") ? 1 : 0
            };
            $.ajax({
                url: '/locations/add', /* php post url */
                type: 'POST',
