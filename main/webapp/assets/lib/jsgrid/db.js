    ...
    var db = {
        ...
        loadData: function (filter) {
            return $.grep(this.clients, function (client) {
                return (!filter.Price || client.Price.indexOf(filter.Price) > -1)
                    && (filter.StartPoint === undefined || client.StartPoint === filter.Age)
                    && (!filter.EndPoint || client.EndPoint.indexOf(filter.EndPoint) > -1)
                    && (!filter.PriceType || client.PriceType === filter.PriceType)
