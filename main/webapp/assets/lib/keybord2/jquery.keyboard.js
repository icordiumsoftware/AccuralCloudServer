...
;(function (factory) {
    ...
    var $keyboard = $.keyboard = function (el, options) {
        ...
        base.isUnavailable = function () {
            return (
                base.$el.is(':disabled') || (
                    ...
                    base.$el.attr('readonly') && !base.$el.hasClass($keyboard.css.locked)
                )
            );
        };
        ...
        base.showSet = function (name) {
            ...
            if (base.metaActive) {
                ...
                if ((!o.stickyShift && base.last.keyset[2] !== base.metaActive) ||
                    ((base.shiftActive || base.altActive) && !base.$keyboard.find('.' + kbcss.keySet + '-' + key + base.rows[toShow]).length)) {
        ...
        base.checkClose = function (e) {
            ...
            if ($target.length && $target.hasClass(kbcss.keyboard)) {
                ...
                if (
                    kb !== base && !kb.$el.hasClass(kbcss.isCurrent) &&
                    kb.options.openOn &&
                    e.type === o.openOn
                ) {
                    kb.focusOn();
    ...
    $.fn.caret = function (start, end, noFocus) {
        if (
            ...
            this.is(':hidden') ||
            this.css('visibility') === 'hidden' || !/(INPUT|TEXTAREA)/.test(this[0].nodeName)
        ) {
            return this;
        }
