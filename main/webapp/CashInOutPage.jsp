        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-header card-default">
                    Product Types
                    <p class="text-muted">All Cash In & Out List</p>
                    <div class="float-right mt-10">
                        <button type="button" class="btn btn-primary margin-r-5 btn-rounded box-shadow btn-icon"
                                data-toggle="modal" data-target=".myModel"><i class="fa fa-plus"></i>Create New Cash in
                            Or Out
                        </button>
                ...
                <div class="card-body">
                    ...
                    <table id="datatable2" class="table dataTable table-striped dt-responsive nowrap">
                        ...
                        <c:forEach items="${dataList}" var="item">
                            <tr>
                                <td>${item.idcashinandcashout}</td>
                                <td> ${item.description}</td>
                                <td> ${item.amount}</td>
                                <td class="text-center">
                                    <c:if test="${item.amount>0}"><span
                                            class="badge badge-success">Cash In</span></c:if>
                                    <c:if test="${item.amount<=0}"><span
                                            class="badge badge-warning">Cash Out</span></c:if>
                                </td>
                                <td class="text-center">
                                    <button type="button" class="btn btn-sm btn-default"><i class="fa fa-search"></i>
                                    </button>
                                    <button type="button" class="btn btn-sm btn-danger delete"
                                            data-set='{"title":"${item.description}", "id":${item.idcashinandcashout}}'>
        ...
        <form id="newproducttypeid" name="newproducttypeid" method="PUT" action="">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h5 class="modal-title" id="myModalLabel">Create New Cash in Or Out</h5>
                </div>
            ...
            swal({
                ...
                preConfirm: function () {
                    return new Promise(function (resolve) {
                        $.ajax({
                            url: 'cahinout/delete/' + data.id, /* php post url */
                            type: 'POST',
                            data: {
                                id: data.id
                            },
